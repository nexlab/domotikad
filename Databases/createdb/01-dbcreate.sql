...
GRANT USAGE ON * . * TO  'asterisk'@'localhost' IDENTIFIED BY  'astdbpwd' WITH MAX_QUERIES_PER_HOUR 0 MAX_CONNECTIONS_PER_HOUR 0 MAX_UPDATES_PER_HOUR 0 MAX_USER_CONNECTIONS 0 ;
